import type { NativeAuthCacheInterface } from '~/routes/nativeAuth/native.auth.cache.interface';
...
export class NativeAuthServerConfig {
   ...
   */
  verifySignature?: (address: string, message: string, signature: Buffer) => boolean | Promise<boolean>;
}
