...
export const STARTER_TEMPLATES: Template[] = [
   ...
   */
  {
    name: 'multiversx-frontend',
    label: 'MultiversX Frontend',
    description: 'Starter template for building a frontend for the MultiversX blockchain',
    githubRepo: 'multiversx/mx-vibechain-template-dapp',
    tags: ['multiversx', 'frontend', 'dApp'],
    icon: 'i-bolt:mx',
  },
